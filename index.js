...
function generarTarjetas(productos) {
    ...
    const tarjetasHTML = productos.reduce((accumulator, producto) => {
        const tarjeta = `
            <div class="producto">
...
function agregarAlCarrito(event) {
    ...
    // Lógica para agregar al carrito (en este caso, almacenamiento local)
    // Aquí podrías implementar tu lógica para gestionar el carrito de compras
    // Por ejemplo, usando localStorage o cualquier otra técnica que prefieras.
    console.log(`Producto ${productId} agregado al carrito.`);
}

// Llamada a la función para generar las tarjetas de productos
